...
$$
\underbrace{p(x_t, m|z\_{1:t}, u\_{1:t})}\_{\text{Online SLAM}} = \int \int \dots \int \underbrace{p(x\_{1:t}, m|z\_{1:t}, u\_{1:t})}\_{\text{Full SLAM}} dx_1 dx_2 \dots dx\_{t-1}
$$
...
$$
\begin{align}
\text{Online SLAM: } p(x_t, m|z\_{1:t}, u\_{1:t}) \Rightarrow p(x_t, m, c_t|z\_{1:t}, u\_{1:t})
\text{Full SLAM: } p(x\_{1:t}, m|z\_{1:t}, u\_{1:t}) \Rightarrow p(x\_{1:t}, m, c\_{1:t}|z\_{1:t}, u\_{1:t})
\end{align}
$$
...
$$
\underbrace{p(x_t, m, c_t|z\_{1:t}, u\_{1:t})}\_{\text{Online SLAM}} = \int \int \dots \int \sum\_{c_1} \sum\_{c_2} \dots \sum\_{c\_{t-1} \underbrace{p(x\_{1:t}, m, c\_{1:t}|z\_{1:t}, u\_{1:t})}\_{\text{Full SLAM}} dx_1 dx_2 \dots dx\_{t-1} 
$$
...
The continouous portion consists of the robot poses and object locations and is highly dimensional. Also the discrete correspondences between detected objects are highly dimensional. These aspects require an approximatino even when known correspondences are assumed.  
