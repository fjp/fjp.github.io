...
- Configuration: In the "Receiver" section select "FrSky FPort" as "Serial Receiver Provider".
- Ports: Enable "Serial Rx" for the UART identifier which is connected with the SmartPort of the receiver.

<figure>
    <a href="/assets/collections/fpv/betaflight/betaflight-ports.jpg"><img src="/assets/collections/fpv/betaflight/betaflight-ports.jpg"></a>
