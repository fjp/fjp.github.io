...
The ESC controls the power supplied from the battery to the motor regarding the commands of a flight controller or a receiver. For example, an ESC can be targeted to provide 50% of the maxium possible power to its connected motor.
