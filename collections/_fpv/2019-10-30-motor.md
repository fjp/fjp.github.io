...
One important constant of a  motor is the [velocity constant](https://en.wikipedia.org/wiki/Motor_constants#Motor_velocity_constant,_back_EMF_constant) $K_v$ also known as [back EMF](back EMF) constant. 
