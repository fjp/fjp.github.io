...
The [Robot Car Kit 2WD](https://joy-it.net/en/products/robot05) from Joy-IT is used as the base for the autonomous mobile robot. The acrylic chassis has many holes which allow to mount a mounting plate that can hold different development boards.
