...
To power the motors the provided battery compartment will be used, which holds four AA batteries ($4 \cdot 1.5V = 6V$).
...
at the front. This sensor can be interfaced via a single [GPIO](https://pinout.xyz/pinout/pin11_gpio17) of the Raspberry Pi.
The code that will be used to wrap this sensor as a ROS node can be found on the [Grove Raspberry Pi](https://github.com/Seeed-Studio/Grove-RaspberryPi/blob/master/Grove%20-%20Ultrasonic%20Ranger/ultrasonic.py) repository on GitHub.
