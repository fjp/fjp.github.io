...
excerpt: "The template method design pattern summarized."
...
classes: wide
header:
  teaser: /assets/pages/design-patterns/template-method-pattern.png
  overlay_image: /assets/pages/design-patterns/template-method-pattern.png
