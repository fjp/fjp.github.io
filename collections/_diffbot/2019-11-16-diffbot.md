...
permalink: /projects/{{ page.collection }}/
...
# classes: wide
header:
  teaser: /assets/collections/{{ page.collection }}/assembly/board-plate/03-board-plate-front-left.jpg
  overlay_image: /assets/collections/{{ page.collection }}/assembly/board-plate/03-board-plate-front-left.jpg
