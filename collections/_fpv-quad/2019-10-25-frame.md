...
Most larger drones commonly consist of a centerplate as their core, arms also known as booms, that hold motors at their ends, and the landing gear. Depending on the size of the motors, dedicated motor mounts are used at the booms to fix the motors.
In the field of FPV race quad frames consist of a single centerplate which includes the arms.


<figure>
  [![Foo](/assets/collections/fpv/frame-components.jpg)](/assets/collections/fpv/frame-components.jpg)
